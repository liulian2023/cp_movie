...
public abstract class Jzvd extends FrameLayout implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, View.OnTouchListener {
    ...
    public void setUp(String url, String title,String playType) {
        setUp(new JZDataSource(url, title,playType), SCREEN_NORMAL);
    }

    public void setUp(String url, String title,String playType, int screen) {
        setUp(new JZDataSource(url, title,playType), screen);
    }
    ...
    public void setUp(String url, String title,String playType, int screen, Class mediaInterfaceClass) {
        setUp(new JZDataSource(url, title,playType), screen, mediaInterfaceClass);
    }
...
//                        mDownY = y;
    ...
    public void startVideo() {
        ...
        this.jzDataSource.getCurrentUrl();
        setCurrentJzvd(this);
        try {
    ...
    public void changeUrl(String url, String title,String playType, long seekToInAdvance) {
        changeUrl(new JZDataSource(url, title,playType), seekToInAdvance);
    }
...
/*                    try {
    ...
    public static void startFullscreenDirectly(Context context, Class _class, String url, String title,String playType) {
        startFullscreenDirectly(context, _class, new JZDataSource(url, title,playType));
    }
