...
public class JZDataSource {
    ...
    public JZDataSource(String url, String title,String playType) {
        urlsMap.put(URL_KEY_DEFAULT, url);
        this.title = title;
    ...
    public JZDataSource(LinkedHashMap urlsMap, String title,String playType) {
        this.urlsMap.clear();
        this.urlsMap.putAll(urlsMap);
        this.title = title;
        this.playType = playType;
    ...
    public JZDataSource cloneMe() {
        ...
        map.putAll(urlsMap);
        return new JZDataSource(map, title,playType);
    }
}
