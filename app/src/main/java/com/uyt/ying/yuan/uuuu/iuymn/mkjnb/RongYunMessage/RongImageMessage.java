 ...
 */
@MessageTag(value = "s:image",flag = MessageTag.ISCOUNTED | MessageTag.ISPERSISTED)


public class RongImageMessage extends MessageContent {
    ...
    public RongImageMessage(String nickname, String pointGrade, String content, String imageUrl, String image,String userId) {
     ...
     */
    public RongImageMessage(byte[] data) {
        String jsonStr = null;
    ...
    // Parcelable中 给消息赋值。
    public RongImageMessage(Parcel in) {
     ...
     */
    public static final Creator<RongImageMessage> CREATOR = new Creator<RongImageMessage>() {

        @Override
        public RongImageMessage createFromParcel(Parcel source) {
            return new RongImageMessage(source);
        }

        @Override
        public RongImageMessage[] newArray(int size) {
            return new RongImageMessage[size];
        }
    };
