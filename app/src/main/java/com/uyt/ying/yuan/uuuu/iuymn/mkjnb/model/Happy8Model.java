...
public class Happy8Model implements Serializable,Comparable<Happy8Model> {
    String betType; //下注类型
    String rebate; //赔率
    String rule_id;//玩法id
    ...
    public Happy8Model(String betType, String rebate, String rule_id, String groupname) {
    ...
    public boolean equals(Object o) {
        ...
        Happy8Model that = (Happy8Model) o;
    ...
    @Override
    public int compareTo(Happy8Model o) {
        try {
