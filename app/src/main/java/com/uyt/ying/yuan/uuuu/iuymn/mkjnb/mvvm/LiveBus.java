...
public class LiveBus {
    ...
    public <T> MutableLiveData<List<T>> postEvent(Object eventKey, String tag, List<T> value) {
        MutableLiveData<List<T>> mutableLiveData = subscribe(mergeEventKey(eventKey, tag));
        mutableLiveData.postValue(value);
        return mutableLiveData;
    }
