 ...
 */
@MessageTag(value = "s:robotBet",flag = MessageTag.ISCOUNTED | MessageTag.ISPERSISTED)

public class LiveSystemBetMessage extends MessageContent {
private String content;
     ...
     */
    public LiveSystemBetMessage(byte[] data) {
        String jsonStr = null;
    ...
    // Parcelable中 给消息赋值。
    public LiveSystemBetMessage(Parcel in) {
     ...
     */
    public static final Creator<LiveSystemBetMessage> CREATOR = new Creator<LiveSystemBetMessage>() {

        @Override
        public LiveSystemBetMessage createFromParcel(Parcel source) {
            return new LiveSystemBetMessage(source);
        }

        @Override
        public LiveSystemBetMessage[] newArray(int size) {
            return new LiveSystemBetMessage[size];
        }
    };

    public LiveSystemBetMessage(String content) {
