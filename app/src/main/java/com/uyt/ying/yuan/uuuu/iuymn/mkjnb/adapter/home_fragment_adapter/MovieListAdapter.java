...
public class MovieListAdapter extends CommonAdapter<MovieListAdapter.MyHolder, HomeMovieModel> {
    Fragment fragment;
    boolean isSearch;
    Activity activity;

    public MovieListAdapter(ArrayList<HomeMovieModel> list, Activity activity, boolean isSearch) {
        super(list);
        this.activity = activity;
        this.isSearch = isSearch;
    }

    public MovieListAdapter(ArrayList<HomeMovieModel> list, Fragment fragment) {
        super(list);
        this.fragment = fragment;
    }

    public MovieListAdapter(ArrayList<HomeMovieModel> list, Activity activity) {
        super(list);
        this.activity = activity;
    }
