...
public class RongTextMessage extends MessageContent {
    ...
    public RongTextMessage(String nickname, String pointGrade, String content, String image, String userId) {
     ...
     */
    public RongTextMessage(byte[] data) {
        String jsonStr = null;
    ...
    // Parcelable中 给消息赋值。
    public RongTextMessage(Parcel in) {
     ...
     */
    public static final Creator<RongTextMessage> CREATOR = new Creator<RongTextMessage>() {

        @Override
        public RongTextMessage createFromParcel(Parcel source) {
            return new RongTextMessage(source);
        }

        @Override
        public RongTextMessage[] newArray(int size) {
            return new RongTextMessage[size];
        }
    };
