...
//import com.cambodia.zhanbang.xunbo.activity.live.LiveRoomFragment;
...
//import com.cambodia.zhanbang.xunbo.utils.LotteryNumColorUtil;
...
//    //点击切换下注列表的tab
//    private RadioButton guanJunDanMaRbt;//冠军单码
//    private RadioButton guanYaHeRbt;//冠亚和
//    private RadioButton guanJunLiangMianRbt;//冠军两面
//
//    private TextView hourTv,minuteTv,secandTv,hourMaoHaoTv;   //倒计时
//    private TextView qishuTv;//期数
//    private MyCornerTextView oneTv,twoTv,threeTv,fourTv,fiveTv,sixTv,sevenTv,eightTv,nineTv,tenTv;//开奖结果
...
////         View contentView = LayoutInflater.from(getActivity()).inflate(R.layout.fragment_race, null);
...
//    WeakReference<RaceFragment> raceFragmentWeakReference;
//    public MyHandler(WeakReference<RaceFragment> raceFragmentWeakReference) {
//        this.raceFragmentWeakReference = raceFragmentWeakReference;
//    }
//
//    public WeakReference<RaceFragment> getRaceFragmentWeakReference() {
//        return raceFragmentWeakReference;
//    }
//
//    public void setRaceFragmentWeakReference(WeakReference<RaceFragment> raceFragmentWeakReference) {
//        this.raceFragmentWeakReference = raceFragmentWeakReference;
//    }
//
//    @Override
//    public void handleMessage(Message msg) {
//        super.handleMessage(msg);
//        RaceFragment raceFragment= raceFragmentWeakReference.get();
//        switch (msg.what){
//            case 1:
//                if(null!=raceFragment){
//                    raceFragment.initOpenResult();//开奖结果数据处理
//                }
//                break;
//            case 2:
//                if(null!=raceFragment){
//                    raceFragment.getMoney();
//                }
//                break;
//        }
//    }
...
//        Utils.docking(data, RequestUtil.REQUEST_26r, 0, new DockingUtil.ILoaderListener() {
//            @Override
//            public void success(String content)  {
//                JSONObject jsonObject1 = JSONObject.parseObject(content);
//                JSONArray farmLotterylist = jsonObject1.getJSONArray("raceLotterylist");
//              ;
...
//                    LotteryNumColorUtil.initLotteryNumColor(myCornerTextView);
//                }
...
//        data.put("type_id",type_id);
//        data.put("source",2);
//        Utils.docking(data, RequestUtil.REQUEST_25r, 0, new DockingUtil.ILoaderListener() {
//            @Override
//            public void success(String content)  {
//                JSONObject jsonObject = JSONObject.parseObject(content);
...
//                            @Override
//                            public void run() {
//                                WeakReference<RaceFragment> raceFragmentWeakReference = handler.getRaceFragmentWeakReference();
//                                RaceFragment raceFragment = raceFragmentWeakReference.get();
//                                if(null!=raceFragment){
//                                    raceFragment.timeTvLinear.setVisibility(View.VISIBLE);
...
//            Utils.docking(data, RequestUtil.REQUEST_01race, -1, new DockingUtil.ILoaderListener() {
//                @Override
//                public void success(String content) {
...
//        //清空选中model list
//        clearSelectorList();
//        RaceEntity raceEntity = JSONObject.parseObject(content, RaceEntity.class);
//        List<RaceEntity.RulelistAllBean> rulelistAll = raceEntity.getRulelistAll();
//        RaceEntity.RulelistAllBean rulelistAllBean;
//        String rulelist;
//        JSONArray jsonArray;
//        if(guanJunDanMaRbt.isChecked()){
//            //冠军单码选中时,取1-10的号码
//            rulelistAllBean = rulelistAll.get(0);
//            rulelist = rulelistAllBean.getRulelist();
//            jsonArray = JSONObject.parseArray(rulelist);
//            for (int i = 0; i < 10; i++) {
...
//
//            }
//        }else if(guanYaHeRbt.isChecked()){
//            //冠亚和按钮选中时,显示冠亚和 --单双大小
//            rulelistAllBean = rulelistAll.get(3);
//            rulelist = rulelistAllBean.getRulelist();
//            jsonArray = JSONObject.parseArray(rulelist);
...
//            }
//        }else {
//            rulelistAllBean = rulelistAll.get(4);
//            rulelist = rulelistAllBean.getRulelist();
//            jsonArray = JSONObject.parseArray(rulelist);
//            for (int i = 0; i < 4; i++) {
//                JSONObject jsonObject = jsonArray.getJSONObject(i);
...
//
//        loadingLinear=view.findViewById(R.id.loading_linear_race);
...
//        guanJunDanMaRbt =view.findViewById(R.id.one_rbt);
//        guanJunDanMaRbt.performClick();
//        guanYaHeRbt =view.findViewById(R.id.two_rbt);
//        guanJunLiangMianRbt =view.findViewById(R.id.three_rbt);
...
//        guanJunDanMaRbt.setOnClickListener(this);
//        guanYaHeRbt.setOnClickListener(this);
//        guanJunLiangMianRbt.setOnClickListener(this);
...
//    }
//
//    private void initChipIvBackgroup(String chipNum) {
