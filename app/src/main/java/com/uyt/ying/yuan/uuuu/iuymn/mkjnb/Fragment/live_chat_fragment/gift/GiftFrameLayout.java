...
public class GiftFrameLayout extends FrameLayout {
    ...
    public void setModel(GiftSendModel model) {
        ...
        if (StringMyUtil.isNotEmpty(model.getGiftRes()) ) {
//            anim_gift.setImageResource(model.getGiftRes());
            GlideLoadViewUtil.LoadNormalView(getContext(), Utils.checkLiveImageUrl(StringMyUtil.isEmptyString(model.getGiftRes())?"":model.getGiftRes()),anim_gift);
       ...
       Activity activity = (Activity) getContext();
        if(activity!=null&&!activity.isFinishing()&&!activity.isDestroyed()){
            Glide.with(getContext())
                    .load(Utils.checkImageUrl(StringMyUtil.isEmptyString(model.getUserAvatarRes())?"":model.getUserAvatarRes()))
