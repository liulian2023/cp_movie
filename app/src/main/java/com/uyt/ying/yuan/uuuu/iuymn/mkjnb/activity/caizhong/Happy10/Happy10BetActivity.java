...
//                                Integer group_id = jsonObject2.getInteger("id");
        ...
        if(popPosition==0){
            ...
            happy10ModelList.add(new Happy10Model(Utils.getString(R.string.第四球),"","",Utils.getString(R.string.两面)+"-"+Utils.getString(R.string.第四球)));
            ...
            happy10ModelList.add(new Happy10Model(Utils.getString(R.string.第五球),"","",Utils.getString(R.string.两面)+"-"+Utils.getString(R.string.第五球)));
            ...
            happy10ModelList.add(new Happy10Model(Utils.getString(R.string.第六球),"","",Utils.getString(R.string.两面)+"-"+Utils.getString(R.string.第六球)));
            ...
            happy10ModelList.add(new Happy10Model(Utils.getString(R.string.第七球),"","",Utils.getString(R.string.两面)+"-"+Utils.getString(R.string.第七球)));
            ...
            happy10ModelList.add(new Happy10Model(Utils.getString(R.string.第八球),"","",Utils.getString(R.string.两面)+"-"+Utils.getString(R.string.第八球)));
            ...
            happy10ModelList.add(new Happy10Model(type,"","",type+"-"+Utils.getString(R.string.第一球)));
            ...
            happy10ModelList.add(new Happy10Model(lianmaType,"","",Utils.getString(R.string.两面)+"-"+typename));
...
//                        time = Long.parseLong(Utils.getFileData("time"));//服务器时间
                        ...
                        shijiancha = SharePreferencesUtil.getLong(Happy10BetActivity.this,"shijiancha",0l);//服务器时间和当地时间差
...
//                customPopupWindow.showHappy8TodayResultPop(todayOpenResultLinear,this);
    ...
    private void randomBet(ArrayList<Happy10Model> happy10MedolList,int num) {
        ...
        for (int i = 0; i < selecterList.size(); i++) {
            ...
            if(betType.equals(Utils.getString(R.string.任选二))|| betType.equals(R.string.任选三)|| betType.equals(Utils.getString(R.string.任选四))|| betType.equals(Utils.getString(R.string.任选五))|| betType.equals(Utils.getString(R.string.选二连组))){
...
//                happy8Model.setBetType(betType);
        ...
        for (int i = 0; i < list.size(); i++) {
          ...
          /*
        选择排序,去重复(因为上面遍历sureBetPopMeldolArrayList,会添加多次相同的数据)
         */
    ...
    private void xingYongRandom() {
        ...
        for (int i = 0; i < selecterList.size(); i++) {
            String betType = selecterList.get(i).getBetType();
            if(betType.equals(Utils.getString(R.string.第一球))||betType.equals(Utils.getString(R.string.第二球))||betType.equals(Utils.getString(R.string.第三球))
                    ||betType.equals(Utils.getString(R.string.第四球))||betType.equals(Utils.getString(R.string.第五球))||betType.equals(Utils.getString(R.string.第六球))
                    ||betType.equals(Utils.getString(R.string.第七球))||betType.equals(Utils.getString(R.string.第八球))){
                xingYongRandom();
            }else{
                break;
            }
