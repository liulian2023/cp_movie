...
public class StatusBarUtils2 {
    ...
    public StatusBarUtils2(Activity activity) {
        mActivity = activity;
    }

    public static StatusBarUtils2 with(Activity activity) {
        return new StatusBarUtils2(activity);
    }
    ...
    public StatusBarUtils2 setColor(int color) {
        mColor = color;
        return this;
    }
    ...
    public StatusBarUtils2 setDrawable(Drawable drawable) {
        mDrawable = drawable;
        return this;
    }
    ...
    public StatusBarUtils2 setIsActionBar(boolean actionBar) {
     ...
     * @return
     */
    public StatusBarUtils2 setDrawerLayoutContentId(boolean drawerLayout, int contentId) {
     ...
     * 去除 ActionBar 阴影
     */
    public StatusBarUtils2 clearActionBarShadow() {
    ...
    public static int getStatusBarHeight(Activity activity) {
        ...
        Utils.logE("getStatusBarHeight", result + "");
        return result;
    }
