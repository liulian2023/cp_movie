...
public class MyCountDownTimer extends CountDownTimer {
    ...
    protected List<MyBackgroundSpan> mBackSpanList;
    ...
    protected char[]  nonNumbers;//保存了天,时,分,秒之间的间隔(Utils.getString(R.string.天),Utils.getString(R.string.时),Utils.getString(R.string.分),Utils.getString(R.string.秒)或者":")
    ...
    public MyCountDownTimer(Context mContext, long mGapTime, String mTimePattern,int mDrawableId) {
        this(mContext,mGapTime,1000,mTimePattern,mDrawableId);
    }
    public MyCountDownTimer(Context mContext, long mGapTime, int mCount, String mTimePattern,int mDrawableId) {
    ...
    protected void initBackSpanStyle(MyBackgroundSpan mBackSpan) {
    ...
    public void onFinish() {
        mDateTv.setText(Utils.getString(R.string.倒计时结束));
    }
