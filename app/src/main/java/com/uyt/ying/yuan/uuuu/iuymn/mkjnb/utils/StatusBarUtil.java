...
//    }
     ...
     * @param activity 目标activity
     */
    public static void setLightMode(@NonNull Activity activity,boolean isDark) {
        darkMode(activity.getWindow(), isDark);
    }
    ...
    private static void setModeForMIUI6(Window window, boolean dark) {
        ...
        try {
            ...
            Utils.logE("StatusBar", "darkIcon: failed");
        }
