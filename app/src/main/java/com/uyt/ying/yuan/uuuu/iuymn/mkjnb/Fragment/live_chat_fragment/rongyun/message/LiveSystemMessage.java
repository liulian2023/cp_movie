 ...
 */
@MessageTag(value = "s:updateStatus",flag = MessageTag.ISCOUNTED | MessageTag.ISPERSISTED)
...
private String content;
     ...
     */
    public LiveSystemMessage(byte[] data) {
        String jsonStr = null;
    ...
    // Parcelable中 给消息赋值。
    public LiveSystemMessage(Parcel in) {
     ...
     */
    public static final Creator<LiveSystemMessage> CREATOR = new Creator<LiveSystemMessage>() {

        @Override
        public LiveSystemMessage createFromParcel(Parcel source) {
            return new LiveSystemMessage(source);
        }

        @Override
        public LiveSystemMessage[] newArray(int size) {
            return new LiveSystemMessage[size];
        }
    };

    public LiveSystemMessage(String content) {
