 ...
 */
@MessageTag(value = "s:liveNormalRed",flag = MessageTag.ISCOUNTED | MessageTag.ISPERSISTED)

public class LiveNormalRedMessage extends MessageContent {
    ...
    public LiveNormalRedMessage(String userInfoJson, String redPrice, String redId, String qbUserName) {
     ...
     */
    public LiveNormalRedMessage(byte[] data) {
        String jsonStr = null;
    ...
    // Parcelable中 给消息赋值。
    public LiveNormalRedMessage(Parcel in) {
     ...
     */
    public static final Creator<LiveNormalRedMessage> CREATOR = new Creator<LiveNormalRedMessage>() {

        @Override
        public LiveNormalRedMessage createFromParcel(Parcel source) {
            return new LiveNormalRedMessage(source);
        }

        @Override
        public LiveNormalRedMessage[] newArray(int size) {
            return new LiveNormalRedMessage[size];
        }
    };
