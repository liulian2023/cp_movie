...
public class BankCardRechargeCenterEntity {
    String mix;
    String max;
    ...
    public BankCardRechargeCenterEntity(String mix, String max, String thirdPartyFlag, String useCzPriceManualInput, List<String> czPrices, String czFdRate) {
        this.mix = mix;
        this.max = max;
        this.thirdPartyFlag = thirdPartyFlag;
        this.useCzPriceManualInput = useCzPriceManualInput;
