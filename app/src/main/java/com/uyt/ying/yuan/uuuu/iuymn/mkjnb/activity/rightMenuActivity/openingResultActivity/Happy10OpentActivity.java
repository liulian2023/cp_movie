...
//没用到(快乐10和农场统一跳转到LuckFramOpenActivity)
public class Happy10OpentActivity extends BaseActivity implements View.OnClickListener, ChooseTimePop.OnItemClidkListener {
    ...
    private ConstraintLayout loadlingLiear;
    ...
    private void bindView() {
        ...
        loadlingLiear=findViewById(R.id.loading_linear);
...
//        getDada(1,15,todayDate,type_id,true,false,false,false,false);
    ...
    private void getDada(int pageNo, int pageSize, String date, int typeId, final boolean isZongHe ,final boolean isLoadMore,boolean isRefresh,boolean showLoad) {
        ...
        if(showLoad){
            loadlingLiear.setVisibility(View.VISIBLE);
        ...
        Utils.docking(data, RequestUtil.REQUEST_04ha, 0, new DockingUtil.ILoaderListener() {
            ...
            public void success(String content)  {
                loadlingLiear.setVisibility(View.GONE);
                ProgressDialogUtil.stop(Happy10OpentActivity.this);
...
//                        needString+=needString+","+markdx+",";
            ...
            public void failed(MessageHead messageHead) {
                ProgressDialogUtil.stop(Happy10OpentActivity.this);
                loadlingLiear.setVisibility(View.GONE);
                ErrorUtil.showErrorLayout(Happy10OpentActivity.this,mRecy,errorLinear,reloadTv);
                if(isRefresh){
 ...
 */
    private void initRefresh() {
        refreshLayout.setRefreshHeader(new ClassicsHeader(Happy10OpentActivity.this));
        refreshLayout.setRefreshFooter(new ClassicsFooter(Happy10OpentActivity.this));
        //上拉加载
