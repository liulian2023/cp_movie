...
public class LiveListAdapter extends BaseDelegateMultiAdapter<Object, BaseViewHolder> {
    Fragment fragment;
    Activity activity;
    static int LIVE_BEAN_TYPE=1;
    static int CLASSIFICATION_BEAN_TYPE=2;
    public LiveListAdapter(Fragment fragment) {
    ...
    private void setViewType() {
        ...
        getMultiTypeDelegate()
                .addItemType(LIVE_BEAN_TYPE,R.layout.live_list_recycle_item)
                .addItemType(CLASSIFICATION_BEAN_TYPE,R.layout.live_list_recycle_item);
    }
    ...
    protected void convert(@NotNull BaseViewHolder baseViewHolder, Object o) {
        if(o instanceof LiveEntity.AnchorMemberRoomListBean ){
            ...
            live_cover_linear.getLayoutParams().height = getWidth();
            live_cover_linear.getLayoutParams().width = getWidth();
    ...
    private int getWidth(){
        ...
        return (mScreenWidth-ScreenUtils.dip2px(getContext(),8)-ScreenUtils.dip2px(getContext(), 8))/2;
    }
}
