 ...
 */
@MessageTag(value = "s:text",flag = MessageTag.ISCOUNTED | MessageTag.ISPERSISTED)

public class LiveTextMessage extends MessageContent {
    ...
    public LiveTextMessage(String userInfoJson, String content) {
     ...
     */
    public LiveTextMessage(byte[] data) {
        String jsonStr = null;
    ...
    // Parcelable中 给消息赋值。
    public LiveTextMessage(Parcel in) {
     ...
     */
    public static final Creator<LiveTextMessage> CREATOR = new Creator<LiveTextMessage>() {

        @Override
        public LiveTextMessage createFromParcel(Parcel source) {
            return new LiveTextMessage(source);
        }

        @Override
        public LiveTextMessage[] newArray(int size) {
            return new LiveTextMessage[size];
        }
    };
