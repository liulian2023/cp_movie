...
public class MyBackgroundSpan extends ImageSpan {
    ...
    public MyBackgroundSpan(Drawable d, int verticalAlignment) {
        super(d, verticalAlignment);
        mTextBound = new Rect();
    }

    public MyBackgroundSpan setTimerTextColor(int mTextColor) {
        this.mTextColor = mTextColor;
        return this;
    }
    public MyBackgroundSpan setTimerTextSize(int textSize){
        this.mTextSize = textSize;
        return this;
    }
    public MyBackgroundSpan setTimerPadding(int left,int top,int right,int bottom){
